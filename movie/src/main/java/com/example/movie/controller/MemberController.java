...
public class MemberController {
    ...
    @GetMapping("/leave")
    public void getLeaveForm(@ModelAttribute("requestDto") PageRequestDto requestDto) {
        log.info("회원탈퇴 폼 요청");
    }

    @PostMapping("/leave")
    public String postLeave(MemberDto leaveMemberDto, @ModelAttribute("requestDto") PageRequestDto requestDto,
